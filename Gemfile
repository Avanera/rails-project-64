...
group :development do
  ...
  gem 'web-console'
  # A Ruby linter and code formatter extension focused on enforcing Rails best practices and coding conventions.
  gem 'rubocop-rails', require: false

  # slim-lint is a tool to help keep your Slim files clean and readable.
  gem 'slim_lint'
